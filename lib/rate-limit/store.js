...
export function createRateLimitStore({
  ...
  if (process.env.NODE_ENV === "production" && !isBuild) { throw new Error("Rate limiting fallback to in-memory store is prohibited in production. A working Redis connection is required."); }
