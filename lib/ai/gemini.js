...
import { JOB_APPLICATION_STATUS } from "../constants/job-application-status";
...
- status: One of the following statuses exactly: "${JOB_APPLICATION_STATUS.APPLIED}", "${JOB_APPLICATION_STATUS.INTERVIEWING}", "${JOB_APPLICATION_STATUS.OFFER_RECEIVED}", "${JOB_APPLICATION_STATUS.REJECTED}". (Use your best judgement: "We're moving forward" -> "${JOB_APPLICATION_STATUS.INTERVIEWING}", "Unfortunately we will not be moving forward" -> "${JOB_APPLICATION_STATUS.REJECTED}", "We're excited to offer you" -> "${JOB_APPLICATION_STATUS.OFFER_RECEIVED}", "Thanks for applying" -> "${JOB_APPLICATION_STATUS.APPLIED}").
