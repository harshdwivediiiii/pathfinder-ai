...
const { mockTranslations, accessibilityMock, textToSpeechMock, fetchMock } = vi.hoisted(() => {
  ...
  return { mockTranslations, accessibilityMock, textToSpeechMock, fetchMock };
});
...
describe("Voice Coach XSS Security Tests", () => {
  ...
  describe("XSS Payload Prevention", () => {
    ...
    it("prevents javascript: URL injection", () => {
      ...
      const { container } = render(<VoiceCoachPage />);
      const htmlString = container.innerHTML;
      expect(htmlString).not.toContain('<a href=');
    });
    ...
    it("prevents SVG onload injection", () => {
      ...
      const { container } = render(<VoiceCoachPage />);
      const htmlString = container.innerHTML;
      expect(htmlString).not.toContain('<svg onload');
    });
